...
module
prelude
public import Lynth.Grind.EMatchTheorem
...
initialize registerTraceClass `lynth_grind.inj
initialize registerTraceClass `lynth_grind.inj.assert
initialize registerTraceClass `lynth_grind.debug.inj
