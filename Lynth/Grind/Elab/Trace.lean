...
/--
In `sym =>` mode, the initialization performed on entry by `lynth_grind =>` (introductions +
...
@[builtin_lynth_grind_tactic finishTrace] def evalFinishTrace : GrindTactic := fun stx => do
