...
module
prelude
public meta import Lynth.Grind.Attr  -- shake: keep (macro output dependency)
open Lean.Meta
public section
namespace Lean.Lynth.Grind

macro (name := _root_.Lean.Parser.Command.registerLynthGrindAttr) doc:(docComment)?
  "register_lynth_grind_attr" id:ident : command => do
