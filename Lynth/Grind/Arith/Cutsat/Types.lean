...
public import Lynth.Grind.Arith.Cutsat.ToIntInfo
open Lean.Meta
public section
...
structure State where
  ...
  The model search is interrupted when this counter reaches the `lynth_liaSteps`
...
initialize cutsatExt : SolverExtension State ← registerSolverExtension (return {})
