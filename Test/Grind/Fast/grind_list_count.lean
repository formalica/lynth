...
theorem countP_nil : countP p [] = 0 := by lynth_grind
...
theorem countP_singleton {a : α} : countP p [a] = if p a then 1 else 0 := by lynth_grind
...
theorem countP_eq_length {p} : countP p l = l.length ↔ ∀ a ∈ l, p a := by
  induction l with lynth_grind [countP_eq_length_filter]
...
theorem Sublist.countP_le (s : l₁ <+ l₂) : countP p l₁ ≤ countP p l₂ := by lynth_grind

theorem IsPrefix.countP_le (s : l₁ <+: l₂) : countP p l₁ ≤ countP p l₂ := by lynth_grind
theorem IsSuffix.countP_le (s : l₁ <:+ l₂) : countP p l₁ ≤ countP p l₂ := by lynth_grind
theorem IsInfix.countP_le (s : l₁ <:+: l₂) : countP p l₁ ≤ countP p l₂ := by lynth_grind

-- See `Init.Data.List.Nat.Count` for `Sublist.le_countP : countP p l₂ - (l₂.length - l₁.length) ≤ countP p l₁`.

theorem countP_tail_le (l) : countP p l.tail ≤ countP p l := by lynth_grind
...
theorem count_nil {a : α} : count a [] = 0 := by lynth_grind

theorem count_cons {a b : α} {l : List α} :
    count a (b :: l) = count a l + if b == a then 1 else 0 := by lynth_grind

theorem count_tail {l : List α} (h : l ≠ []) (a : α) :
      l.tail.count a = l.count a - if l.head h == a then 1 else 0 := by
  induction l with lynth_grind

theorem count_le_length {a : α} {l : List α} : count a l ≤ l.length := by lynth_grind

theorem Sublist.count_le (a : α) (h : l₁ <+ l₂) : count a l₁ ≤ count a l₂ := by lynth_grind

theorem IsPrefix.count_le (a : α) (h : l₁ <+: l₂) : count a l₁ ≤ count a l₂ := by lynth_grind
theorem IsSuffix.count_le (a : α) (h : l₁ <:+ l₂) : count a l₁ ≤ count a l₂ := by lynth_grind
theorem IsInfix.count_le (a : α) (h : l₁ <:+: l₂) : count a l₁ ≤ count a l₂ := by lynth_grind
...
theorem count_append {a : α} {l₁ l₂ : List α} : count a (l₁ ++ l₂) = count a l₁ + count a l₂ := by lynth_grind
...
theorem count_singleton_self {a : α} : count a [a] = 1 := by lynth_grind
...
theorem count_erase_self {a : α} {l : List α} :
    count a (List.erase l a) = count a l - 1 := by lynth_grind
...
theorem count_erase {a b : α} {l : List α} : count a (l.erase b) = count a l - if b == a then 1 else 0 := by
  induction l <;> lynth_grind [-List.count_erase]
...
theorem count_concat_self {a : α} {l : List α} : count a (concat l a) = count a l + 1 := by lynth_grind
