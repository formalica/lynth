...
example (a : R) : (-2 : Int) • a = -a - a := by lynth_grind
example (b c : R) : 2 • (b + c) = c + 2 • b + c := by lynth_grind
example (b c : R) : 2 • (b + c) - 3 • c + b + b = c + 5 • b - 2 • c - b := by lynth_grind
example (b c : R) : 2 • (b + c) + (-3 : Int) • c + b + b = c + (5 : Int) • b - 2 • c - b := by lynth_grind
example (b : R) : 2 • b = 1 • b + b := by lynth_grind

example [CommRing α] (b : α) : 2 • b = 1 • b + b := by lynth_grind -ring
example [CommRing α] (b : α) : 2*b = 1*b + b := by lynth_grind
