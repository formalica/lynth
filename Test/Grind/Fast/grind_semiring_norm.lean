...
example (a b c : R) : a * (b + c) = a * c + b * a := by lynth_grind
example (a b : R) : (a + b)^2 = a^2 + 2 * a * b + b^2 := by lynth_grind
example (a b : R) : (a + 2 * b)^2 = a^2 + 4 * a * b + 4 * b^2 := by lynth_grind
example (a b : R) : (a + 2 * b)^2 = 4 * b^2 + b * 4 * a + a^2 := by lynth_grind

example (a b : R) : (a + b)^2 ≠ a^2 + 2 * a * b + b^2 → False := by lynth_grind
...
example (a b c d : R) : c + d = d → (a + b)^2 ≠ a^2 + 2 * a * b + b^2 → False := by lynth_grind
