...
example (a b c : R) (h : a < b) : a + c < b + c := by lynth_grind
example (a b c : R) (h : a < b) : c + a < c + b := by lynth_grind
example (a b : R) (h : a < b) : -b < -a := by lynth_grind
...
example (a b : R) (h : a < b) : -a < -b := by lynth_grind
...
example (a : R) (h : 0 < a) : 0 ≤ a := by lynth_grind
example (a : R) (h : 0 < a) : -2 • a < 0 := by lynth_grind

example (a b c : R) (_ : a ≤ b) (_ : b ≤ c) : a ≤ c := by lynth_grind
example (a b c : R) (_ : a ≤ b) (_ : b < c) : a < c := by lynth_grind
example (a b c : R) (_ : a < b) (_ : b ≤ c) : a < c := by lynth_grind
example (a b c : R) (_ : a < b) (_ : b < c) : a < c := by lynth_grind

example (a : R) (h : 2 • a < 0) : a < 0 := by lynth_grind
example (a : R) (h : 2 • a < 0) : 0 ≤ -a := by lynth_grind
