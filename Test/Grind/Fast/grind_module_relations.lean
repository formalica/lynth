...
example (a b : R) (h : a + b = 0) : 3 • a - 7 • b = 9 • a + a := by lynth_grind
example (a b c : R) (h : 2 • a + 2 • b = 4 • c) : 3 • a + c = 5 • c - b + (-b) + a := by lynth_grind
...
example (a : R) (h : a + a = 0) : a = 0 := by lynth_grind
example (a b c : R) (h : 2 • a + 2 • b = 4 • c) : 3 • a + c = 7 • c - 3 • b := by lynth_grind
